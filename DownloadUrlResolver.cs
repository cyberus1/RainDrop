// edited 22/7/2015: by tariqalkhassa Solved 403 Forbidden Error  //Cyberus Edit
...
namespace YoutubeExtractor
{
    ...
    public static class DownloadUrlResolver
    {
        ...
        private static IEnumerable<ExtractionInfo> ExtractDownloadUrls(JObject json)
        {
            ...
            // start Cyberus edit
            //splitByUrls = splitByUrls.Concat(adaptiveFmtSplitByUrls).ToArray(); //origonal
        ...
        private static string GetAdaptiveStreamMap(JObject json)
        {
            ...
            {
                return string.Empty; //Cyberus Edit
            }
        }
